...
namespace RPNCalc
{
	...
	public static partial class TermLib
	{
		...
		public enum OPRType
		{
			ERROPR,EQUAL,PLUS,MINUS,MULT,DIV,MORE,LESS,EXL_MRK,AMPERSANT,VERT_BAR,PERCENT,	//one symbol operarors
			DBL_EQUAL,PLUS_EQUAL,MINUS_EQUAL,MULT_EQUAL,MORE_EQUAL,LESS_EQUAL,DBL_EXL_MRK,DBL_AMPERSANT,DBL_VERT_BAR,RIGHT_SHIFT,
			LEFT_SHIFT,INCREMENT,DECREMENT,DBL_PERCENT	//two symbol operators
		};
